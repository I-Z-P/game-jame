...
class Animation(pygame.sprite.Sprite):
    ...
    def load_player_body(self, player_images=[], sprite_sheet=False):
        ...
        if not sprite_sheet:
            ...
            for type, values in player_images.items():
                ...
                scaling_size = (1,1)#(TILE_SIZE * self.scaling * self.n_animations, TILE_SIZE * self.scaling)
    ...
    def get_sprite(self, x, y, w, h):
        ...
        sprite = pygame.Surface((TILE_SIZE-2, TILE_SIZE-2))
    ...
    def update(self, position):
        self.rect.x = position[0] - self.rect.h
